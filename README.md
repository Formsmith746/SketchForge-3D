  ...
  <table>
    <tr>
      ...
      <td>
        ...
        <p align="right">
          Build shapes, cut holes, group parts, import STL files, and export models without accounts or heavyweight CAD setup.
        </p>
      </td>
    </tr>
  </table>
...
SketchForge is local-first in every setup. The app files may be served from a computer or server, but projects stay in each user's browser storage. STL and OBJ exports download through the user's browser. SketchForge does not upload models to a remote project service.
