...
type WorkplaneViewportProps = {
  ...
  tutorialResizeActive?: boolean;
  onTutorialResizeStart?: () => void;
...
export function WorkplaneViewport({
  ...
  useEffect(() => {
    ...
    if (!state) return;
    state.controls.enabled = !interactionLocked;
  ...
  }, [interactionLocked, resetView, rulerToolsOpen, setRulerActive, zoomCamera]);
        ...
        <div className="workplane-plane">
          ...
          {transformOverlay && !alignMode && !mirrorMode && !rulerMode && !rulerDeleteMode && !rulerMoveMode && !modifierActive ? (
            <TransformOverlay
              ...
              tutorialResizeActive={tutorialResizeActive}
              onTutorialResizeStart={onTutorialResizeStart}
